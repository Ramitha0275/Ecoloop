...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onSwitchToSignUp, t, language, setLanguage }) => {
    ...
    <div className="min-h-screen flex items-center justify-center px-4 animate-fade-in">
      <div className="w-full max-w-md">
        <div className="bg-slate-900/70 backdrop-blur-lg p-8 rounded-2xl shadow-lg text-center relative">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">{t('login_welcome')}</h1>
          <p className="text-slate-300 mb-8">{t('login_subtitle')}</p>
          ...
          <div className="mt-6 text-sm">
            <p className="text-slate-400">
              ...
              <button onClick={onSwitchToSignUp} className="font-semibold text-eco-green hover:underline">
                {t('signup_button')}
              </button>
            </p>
          </div>
